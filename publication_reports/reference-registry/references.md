...
- **Generated:** 2026-08-24T12:51:34.311Z

## Change control

- **Summary:** Evidence reference changed: references[NICE-NG109] › next Review Due; Evidence reference changed: references[NICE-NG109] › review Status; Evidence reference changed: references[NICE-NG109] › reviewed By; plus 1 other change.
- **Risk:** reference-update
- **Selected version increase:** minor
- **Recommended version increase:** patch
- **Changed fields:** 2
- **Override reason:** Review-cycle versioning keeps this new post-publication cycle on 0.4.x.
...
- **Reviewer:** Sean McGrory
- **Reviewer role:** tAPUC
- **Reviewed at:** 2026-08-24T12:00:00.000Z
- **Notes:** Added reference: NICE-NG109 — Urinary tract infection (lower): antimicrobial prescribing
...
- **Generated:** 2026-08-23T17:59:44.241Z

## Change control

- **Summary:** Evidence reference changed: references[NICE-CKS-CONJUNCTIVITIS] › next Review Due.
- **Risk:** reference-update
- **Selected version increase:** minor
- **Recommended version increase:** patch
- **Changed fields:** 1
- **Override reason:** Review-cycle versioning keeps this new post-publication cycle on 0.3.x.
...
- **Reviewer:** Sean McGrory
- **Reviewer role:** tAPUC
- **Reviewed at:** 2026-08-23T12:00:00.000Z
- **Notes:** Updated reference: NICE-CKS-CONJUNCTIVITIS — Conjunctivitis
